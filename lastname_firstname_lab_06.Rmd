...
library(tidyverse)
dat <- read.csv("C:/Users/ericg/UCF/github/lab-06/data/glopnet_dat.csv", na.strings="")
```

## Instructions

- Before beginning this assignment, go ahead and Save As, replacing lastname and firstname with your name, followed by `_lab_06.Rmd`.
- Enter your name for author at the top of this document (where it says `author: "Your Name"`).
- If you'd like, use the visual markdown editor by clicking the top-right button of this document (the one that looks sort of like an A).
